...
client = LINE("EvknX7fJgrMohJsE4ch6.DvYCPjn30yz+OQTzjVWInG.EpmDpH8CIxO21JE966xbIvzV8QCSQvaWsvrIfN2WhpY=")
#client = LINE("")
...
admin = ["u755c9ca49377d1867fa2ab5926fc2236"]
...
# Pembatas Script #
                                ...
                                if msg._from in admin:   
                                   ...
                                   for group in groups:
                                       ...
                                       client.sendMessage(to, "Success broadcast to {} group").format(str(len(grouplist)))
