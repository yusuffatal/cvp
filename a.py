...
client = LINE("EtISPyuyPLv6UX7SvXG5.IqtJipTzyCWvcrgownX/bq.5D/r2WQ6AsjfChGOyreLI5MGixnFfoOgKoom3fWVbMk=")
...
# Pembatas Script #   
                            ...
                            elif "/ti/p/~ " in msg.text.lower():
                                if settings["sc"] == True:
                                    try:
                                         midd = msg.text.lower().replace("/ti/p/~ ","")
