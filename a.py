...
client = LINE("EtjcB9Jh52UXLr8bJkD5.IqtJipTzyCWvcrgownX/bq.RHXLaqarlplj0IPBZDbZht1aBWuISwrECER+zYVRcM8=")
clientMid = client.profile.mid
clientProfile = client.getProfile()
clientSettings = client.getSettings()
clientPoll = OEPoll(client)

ki = LINE("Etrj8ZMmm3QQK9gdUNaf.aXKsmGph9h8IqosquepKZW.zmSbGnmGKyQ+xYmeninTeTgYvlfET5KvS0kkGxa1DZQ=")
...
def clientBot(op):
    try:
        ...
        if op.type == 15:
            if settings["ya"] == True:
                da = ki.getContact(op.param2)
                ya = ki.getGroup(op.param1)
                sendMention(op.param2, "Hai @!,\nkenapa out dari grup {} ? ".format(str(ya.name)),[da.mid])
...
# Pembatas Script #   
                                ...
                                if msg._from in admin:   
                                   ...
                                   for group in groups:
                                       ...
                                       ki.sendMessage(to, "Success broadcast to {} group".format(str(len(groups))))
