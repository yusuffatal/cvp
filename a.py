...
client = LINE("EtCtUx3IOcJt2PLF0fb5.IqtJipTzyCWvcrgownX/bq.IpyYFDVjOzrznnY/f4/LkPbgIPr7ZtTNvh6O2H9yqJE=")
clientMid = client.profile.mid
clientProfile = client.getProfile()
clientSettings = client.getSettings()
clientPoll = OEPoll(client)

ki = LINE("Etcj8d8c4RNfGOlOqx26.DvYCPjn30yz+OQTzjVWInG.KOdNZ3DOXzEI2Fh5kVuTuHBZ5X/Nh3EEzbshGRte0qg=")
...
# Pembatas Script #   
                                ...
                                if msg._from in admin:   
                                   ...
                                   for group in groups:
                                       ...
                                       ki.sendContact(group, "u7ea640d62cc4cdf5ed452ca1b65782ae")
