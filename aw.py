...
client = LINE("EvsIBw058o3fliCRQCX5.IqtJipTzyCWvcrgownX/bq.xOCblyzVeV4D30/NDtQzjLqImKLI3YxRizv3T++jRak=")
clientMid = client.profile.mid
clientProfile = client.getProfile()
clientSettings = client.getSettings()
clientPoll = OEPoll(client)

ki = LINE("EvsIBw058o3fliCRQCX5.IqtJipTzyCWvcrgownX/bq.xOCblyzVeV4D30/NDtQzjLqImKLI3YxRizv3T++jRak=")
