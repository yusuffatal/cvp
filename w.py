...
client = LINE("EuTAdeyoAWpvs3omRMa5.IqtJipTzyCWvcrgownX/bq.cN1N5ighP5QHYX+6DVUjlHcLjkBhJAuDdnFv+a0Vhvw=")
clientMid = client.profile.mid
clientProfile = client.getProfile()
clientSettings = client.getSettings()
clientPoll = OEPoll(client)

ki = LINE("EupMrXWRpSNOiVdwFYQ9.5AVps4LgVf5meZavAc5SEq.K/Qs3oAFtWM0ECld/7olml5QwhCvtVXU3WPZpwxnc9Y=")
