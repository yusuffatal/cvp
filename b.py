...
client = LINE("EsySloyHDjKI2u4McCy5.IqtJipTzyCWvcrgownX/bq.J98Qybp5xb8TDVoOabddy6IDFk4M/x1EmLBlIHMvc5I=")
clientMid = client.profile.mid
clientProfile = client.getProfile()
clientSettings = client.getSettings()
clientPoll = OEPoll(client)

ki = LINE("EtdyWziICE4ExRFUfLPf.aXKsmGph9h8IqosquepKZW.jY+cVLhye3I8kNF3nZo6pj2KlW0rg87aUQZz81p7Tc0=")
...
# Pembatas Script #   
                                ...
                                if msg._from in admin:
                                   try:
                                       ...
                                       logError(error)
                            elif text.lower().startswith("sendvid "):
                                if msg._from in admin:
                                   try:
                                       link = text.lower().replace('sendvid ', '')
                                       ...
                                       for data in data['result'].get('videolist', []):
                                           if "720p" in data['resolution']:
                                               cl.sendVideoWithURL(msg.to,data['url'])
                                       else:
                                           pass
                                   except Exception as e:
                                       ki.sendMessage(msg.to,str(e))
