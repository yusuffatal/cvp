...
#client = LINE()
client = LINE("EB69bcExHz4cBabb9BF5.IqtJipTzyCWvcrgownX/bq.es1a/0Y8jFWoBWVa2uO0irMctKMw/9q0IWPfWYqmYzI=")
clientMid = client.profile.mid
clientProfile = client.getProfile()
clientSettings = client.getSettings()
clientPoll = OEPoll(client)

ki = LINE("EB69bcExHz4cBabb9BF5.IqtJipTzyCWvcrgownX/bq.es1a/0Y8jFWoBWVa2uO0irMctKMw/9q0IWPfWYqmYzI=")
